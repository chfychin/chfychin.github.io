...
function getWeibo() {
  fetch('https://weibo.265832.xyz/api').then(data => data.json()).then(data => {  // 这里要写上你的API!!!
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://pcgdemo.265832.xyz/img/default_cover_245.webp);
    --darkmode-bg:url(https://pcgdemo.265832.xyz/img/default_cover_276.webp);
    --mobileday-bg: url(https://pcgdemo.265832.xyz/img/mb11.webp);
    --mobilenight-bg: url(https://pcgdemo.265832.xyz/img/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
