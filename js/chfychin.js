...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Chfychin🥝")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'TXWBZ-2UUCQ-FO75Q-2P7SA-3PZLT-RZBMX',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(114.348666, 36.066304, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        borderRadius: 5 + 'px',
        right: 55.6 + 'px',
        nekoImg: "https://tuchuang.voooe.cn/images/2024/09/01/cat.png",
        hoverMsg: "春天啦~",
        // hoverMsg: "夏天的风~",
        // hoverMsg: "要秋收啦~",
        // hoverMsg: "冬日雪景~",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Chfychin🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Chfychin🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if (m == 6 && dd == 30) {//小猫咪生日
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("祝小猫咪" + (y - 2004).toString() + "岁生日快乐！🐱");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
...
function createtime() {
  ...
  var start = new Date("03/16/2024 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("03/16/2024 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='./assets/gulp/comment_bg.png' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='./assets/gulp/comment_bg.png' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://pcgdemo.chfychin.cn/img/default_cover_245.webp);
    --darkmode-bg:url(https://pcgdemo.chfychin.cn/img/default_cover_276.webp);
    --mobileday-bg: url(https://pcgdemo.chfychin.cn/img/mb11.webp);
    --mobilenight-bg: url(https://pcgdemo.chfychin.cn/img/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_271.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_271.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_259.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_259.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_204.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_204.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_26.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_26.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_49.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_49.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/dm1.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/dm1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/p35.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/p35.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_138.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_138.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_page_cover.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_page_cover.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_131.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_131.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_134.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_134.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_145.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_145.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_203.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_203.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_212.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_212.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_245.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_245.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_271.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_271.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mc1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mc5.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mc5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mc7.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mc7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mc8.webp)" class="imgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mc8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mb2.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mb2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mb4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mb7.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mb7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mb8.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mb8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_206.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_206.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_230.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_230.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/default_cover_240.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/default_cover_240.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://pcgdemo.chfychin.cn/img/mb13.webp)" class="pimgbox" onclick="changeBg('url(https://pcgdemo.chfychin.cn/img/mb13.webp)')"></a></div>
              </div>
            </details>
...
//     "horizontal": "left",
//     "city": "CN101180206",
//     "key": "35ecf5cbd8af4662b56e7427e5dece6f"
//   }
// }
...
function cardTimes() {
  ...
  const e = document.getElementById("card-calendar");
  if (e) {
    ...
    e.querySelector("#calendar-week").innerHTML = `${year}年${monthStr}&nbsp;${weekStr}`;
