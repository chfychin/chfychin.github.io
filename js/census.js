var start_date = '20240315' // 开始日期
var date = new Date();
var end_date = '20240815' + date.getFullYear() + (date.getMonth() > 8 ? (date.getMonth() + 1) : ("0" + (date.getMonth() + 1))) + (date.getDate() > 9 ? date.getDate() : ("0" + date.getDate())); // 结束日期

var access_token = '' // accessToken
var site_id = '' // 网址 id
var dataUrl = '' + access_token + '&site_id=' + site_id
// var dataUrl = 'https://baidu-tongji.fomal.cc/api?site_id=' + site_id
// var dataUrl = 'https://tongji.eurkon.com/api?site_id=' + site_id
